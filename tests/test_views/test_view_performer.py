...
class PrivatePerformerFormatTest(TestCase):
    def setUp(self) -> None:
        ...
        self.performer1 = Performer.objects.create(first_name="t1", last_name="tt", nickname="ttt"),
        self.performer2 = Performer.objects.create(first_name="t2", last_name="tt2", nickname="ttt2")
    ...
    def test_performer(self):
        ...
        self.assertEqual(
            list(response.context["performer_list"]),
            list(performer)
        )
