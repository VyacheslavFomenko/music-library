...
urlpatterns = [
    ...
    path(
        "song/<int:pk>/add-to-favourite-song",
        AddSongToFavoritesView.as_view(),
        name="add-to-favourite-song",
    ),
